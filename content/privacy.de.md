...
### GitHub Pages
Diese Website wird als statische Seite auf GitHub Pages bereitgestellt. Die personenbezogenen Daten, die auf dieser Website erfasst werden (vor allem Server-Logfiles wie IP-Adressen), werden auf den Servern von GitHub gespeichert. 
...
Der Einsatz von GitHub Pages erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der sicheren und effizienten Bereitstellung unseres Online-Angebots). Da Daten in die USA übertragen werden können, weisen wir darauf hin, dass GitHub entsprechende Standardvertragsklauseln nutzt, um ein angemessenes Datenschutzniveau zu gewährleisten.
